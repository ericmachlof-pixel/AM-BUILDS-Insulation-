...
const FALLBACK_TESTIMONIALS = [
  ...
  { author_name: 'Sandra K.',   location: 'Oakland, CA',        stars: 5, quote: 'Had a severe rat infestation. Insulara came in, sealed 23 entry points, cleaned the attic, and installed new insulation. Zero rodent issues since.' },
  ...
  { author_name: 'Priya L.',    location: 'Fremont, CA',        stars: 5, quote: 'The spray foam in our garage has been a game changer. It\'s warmer in winter, cooler in summer, and completely quiet. Best home investment we\'ve made.' },
  { author_name: 'Robert C.',   location: 'San Francisco, CA',  stars: 5, quote: 'Called Insulara after finding rat droppings in my attic. They came out the next day, sealed everything up, removed the old insulation, and put in new. Haven\'t seen a single sign of rodents since.' },
  ...
  { author_name: 'Maria G.',    location: 'Sacramento, CA',     stars: 5, quote: 'Had three other companies quote us. Insulara was thorough, honest, and didn\'t try to oversell. The spray foam in our walls has made a huge difference — the house is so much quieter too.' },
  { author_name: 'James W.',    location: 'San Diego, CA',      stars: 5, quote: 'I manage several rental properties and Insulara is now my go-to for all of them. Fast turnaround, quality work, and the tenants always notice the difference in comfort.' },
